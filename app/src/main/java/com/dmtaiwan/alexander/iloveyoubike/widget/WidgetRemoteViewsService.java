    ...
    public RemoteViewsFactory onGetViewFactory(final Intent intent) {
        return new RemoteViewsFactory() {
            ...
            public RemoteViews getViewAt(int position) {
                ...
                String time = Utilities.formatTime(data.getString(StationContract.COL_LAST_UPDATED));

                //Get distance
                String distanceString = "";
                double stationLat = data.getDouble(StationContract.COL_STATION_LAT);
                double stationLong = data.getDouble(StationContract
                        .COL_STATION_LONG);
